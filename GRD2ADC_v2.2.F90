...
!           Portions of this routine to lookup what raster cell the node is in
!           were obtained from Crystal Fulcher's surface roughness codes
!           (mannings_n_finder, surface_roughness_cal, and surface_canopy)
!           (http://adcirc.org/Utility_programs.html)
